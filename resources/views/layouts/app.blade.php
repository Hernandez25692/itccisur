...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gradient-to-b from-slate-50 via-white to-slate-100 text-gray-800">
        <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
            ...
            <aside class="w-64 bg-gradient-to-b from-[#0C1C3C] to-[#1A2A4F] shadow-2xl flex flex-col transition-all duration-300 overflow-y-auto"
                ...
                <nav class="flex-1 px-4 py-6 space-y-1">
                    ...
                    <div class="mb-6">
                        ...
                        <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 text-blue-100 rounded-lg transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-[#C5A049] text-white shadow-lg' : 'hover:bg-blue-900/30' }}">
                        ...
                        @role('admin_ti|gerencia')
                            <a href="{{ route('dashboard.ti') }}" class="flex items-center px-4 py-3 text-blue-100 rounded-lg transition-all duration-200 {{ request()->routeIs('dashboard.ti') ? 'bg-[#C5A049] text-white shadow-lg' : 'hover:bg-blue-900/30' }}">
                    ...
                    <div class="mb-6">
                        ...
                        <a href="{{ route('plan-trabajo.index') }}" class="flex items-center px-4 py-3 text-blue-100 rounded-lg transition-all duration-200 {{ request()->routeIs('plan-trabajo.*') ? 'bg-[#C5A049] text-white shadow-lg' : 'hover:bg-blue-900/30' }}">
                        ...
                        <a href="{{ route('bitacora.index') }}" class="flex items-center px-4 py-3 text-blue-100 rounded-lg transition-all duration-200 {{ request()->routeIs('bitacora.*') ? 'bg-[#C5A049] text-white shadow-lg' : 'hover:bg-blue-900/30' }}">
                        ...
                        @role('admin_ti')
                            <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-3 text-blue-100 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-[#C5A049] text-white shadow-lg' : 'hover:bg-blue-900/30' }}">
                    ...
                    <div class="mb-6">
                        ...
                        <a href="{{ route('control.index') }}" class="flex items-center px-4 py-3 text-blue-100 rounded-lg transition-all duration-200 {{ request()->routeIs('control.*') ? 'bg-[#C5A049] text-white shadow-lg' : 'hover:bg-blue-900/30' }}">
                ...
                <div class="px-4 py-6 border-t border-blue-900/30">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="mt-3">
                        @csrf
                        <button type="submit" class="w-full flex items-center px-4 py-2 text-sm text-blue-100 hover:bg-red-900/30 rounded-lg transition-all duration-200">
