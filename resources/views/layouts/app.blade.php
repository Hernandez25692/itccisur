...
<body class="font-sans antialiased bg-gradient-to-b from-slate-50 via-white to-slate-100 text-gray-800">
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar Desktop -->
        <aside class="sidebar-desktop lg:w-64 bg-gradient-to-b from-[#0C1C3C] to-[#1A2A4F] shadow-2xl flex flex-col overflow-y-auto"
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                <!-- Sección Principal -->
                <div class="mb-6">
                    <p class="px-4 py-2 text-xs font-semibold text-blue-300 uppercase tracking-wide" :class="{ 'hidden': !sidebarOpen }">Principal</p>
                    ...
                    <a href="{{ route('dashboard') }}"
                       ...
                       :title="!sidebarOpen ? 'Inicio' : ''">
                        ...
                        @if (request()->routeIs('dashboard'))
                            <span class="ml-auto w-1 h-6 bg-white rounded-full flex-shrink-0" :class="{ 'hidden': !sidebarOpen }"></span>
                        @endif
                    </a>
                        ...
                        @if (Route::has('calendario-editorial.dashboard'))
                            <a href="{{ route('calendario-editorial.dashboard') }}"
                               ...
                               :title="!sidebarOpen ? 'Resumen Calendario' : ''">
                                ...
                                <span class="ml-3 font-medium truncate" :class="{ 'hidden': !sidebarOpen }">Resumen Calendario</span>
                    ...
                    @role('admin_ti|gerencia')
                        <a href="{{ route('dashboard.ti') }}"
                           ...
                           :class="{ 'justify-center px-3': !sidebarOpen }"
                           :title="!sidebarOpen ? 'Dashboard TI' : ''">
                            <i class="fas fa-chart-line w-5 text-lg flex-shrink-0"></i>
                ...
                <!-- Sección Gestión -->
                <div class="mb-6">
                    <p class="px-4 py-2 text-xs font-semibold text-blue-300 uppercase tracking-wide" :class="{ 'hidden': !sidebarOpen }">Gestión</p>
                    ...
                    @role('admin_ti|gerencia')
                        <a href="{{ route('plan-trabajo.index') }}"
                           ...
                           :title="!sidebarOpen ? 'Plan de Trabajo TI' : ''">
                            ...
                            <span class="ml-3 font-medium truncate" :class="{ 'hidden': !sidebarOpen }">Plan de Trabajo TI</span>
                    ...
                    @role('GOR|admin_ti|gerencia')
                        <a href="{{ route('gor.antecedentes.index') }}"
                           ...
                           :class="{ 'justify-center px-3': !sidebarOpen }"
                           :title="!sidebarOpen ? 'Gerencia de Operaciones Registrales' : ''">
                            <i class="fas fa-building w-5 text-lg flex-shrink-0"></i>
                            <span class="ml-3 font-medium truncate" :class="{ 'hidden': !sidebarOpen }">Gerencia de Operaciones Registrales</span>
                    ...
                    @role('admin_ti')
                        <a href="{{ route('admin.users.index') }}"
                           ...
                           :title="!sidebarOpen ? 'Gestión de Usuarios' : ''">
                            ...
                            <span class="ml-3 font-medium truncate" :class="{ 'hidden': !sidebarOpen }">Gestión de Usuarios</span>
                ...
                <!-- Sección Control -->
                <div class="mb-6">
                    <p class="px-4 py-2 text-xs font-semibold text-blue-300 uppercase tracking-wide" :class="{ 'hidden': !sidebarOpen }">Control</p>
                    @role('admin_ti|gerencia')
                        <a href="{{ route('control.index') }}"
                           ...
                           :class="{ 'justify-center px-3': !sidebarOpen }"
                           :title="!sidebarOpen ? 'Control TI' : ''">
                            <i class="fas fa-shield w-5 text-lg flex-shrink-0"></i>
                            <span class="ml-3 font-medium truncate" :class="{ 'hidden': !sidebarOpen }">Control TI</span>
            ...
            <div class="px-4 py-6 border-t border-blue-900/30 flex-shrink-0"
                 :class="{ 'px-3': !sidebarOpen }">
        ...
        <!-- Sidebar para móvil -->
        <aside class="lg:hidden fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-[#0C1C3C] to-[#1A2A4F] shadow-2xl z-50 overflow-y-auto mobile-menu-container"
               :class="{ 'active': mobileMenuOpen }">
            ...
            <div class="sticky top-0 bg-gradient-to-b from-[#0C1C3C] to-[#1A2A4F] z-10 flex-shrink-0">
                <div class="flex items-center justify-between px-6 py-4 border-b border-blue-900/30">
                    ...
                    <button @click="mobileMenuOpen = false" class="text-white hover:text-[#C5A049] transition-colors flex-shrink-0">
                ...
                <div class="px-6 py-4 border-b border-blue-900/30">
                    <div class="flex items-center min-w-0">
                        <div class="w-12 h-12 bg-[#C5A049] rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <div class="flex-1 flex flex-col overflow-hidden main-container" :class="{ 'lg:ml-20': !sidebarOpen }">
            ...
            <header class="bg-white shadow-sm border-b flex-shrink-0">
                <div class="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 gap-2 sm:gap-4">
                    <!-- Botón menú móvil -->
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden text-gray-600 hover:text-gray-900 transition-colors flex-shrink-0">
                        <i class="fas fa-bars text-xl"></i>
                    </button>
                    
                    <!-- Botón menú desktop -->
                    <button @click="sidebarOpen = !sidebarOpen" class="hidden lg:block text-gray-600 hover:text-gray-900 transition-colors flex-shrink-0">
                        <i class="fas fa-bars text-xl"></i>
                    </button>
                    ...
                    <!-- Reloj y hora -->
                    <div class="text-sm text-gray-500 flex-shrink-0" x-data="{ time: '' }" 
                         x-init="
                            const updateTime = () => {
                    ...
                    <button @click="document.querySelector('#logout-form-mobile').submit()" class="lg:hidden text-gray-600 hover:text-red-600 transition-colors flex-shrink-0">
            ...
            @isset($header)
                <div class="px-4 sm:px-6 py-3 sm:py-6 flex-shrink-0">
                    <div class="bg-white shadow-sm rounded-xl p-4 sm:p-6 border border-gray-200">
                        <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 flex items-center gap-3 sm:gap-4">
                            <span class="inline-block w-1 h-6 sm:h-7 lg:h-8 bg-[#C5A049] rounded-full flex-shrink-0"></span>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(event) {
                ...
                if (mobileMenu && mobileMenu.classList.contains('active')) {
                    if (!mobileMenu.contains(event.target) && !event.target.closest('[\\@click*="mobileMenuOpen"]')) {
