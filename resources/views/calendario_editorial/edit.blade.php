    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Modifique los detalles de la publicación en redes sociales</p>
            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="tema" rows="2" required
                                        ...
                                        placeholder="Ingrese el tema o título principal de la publicación">{{ old('tema', $calendarioEditorial->tema) }}</textarea>
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="area"
                                        ...
                                        @foreach (['Día festivo', 'Calendario', 'Bienvenida socios', 'Post capacitación', 'Servicio empresarial', 'Comunicado', 'Nota de duelo',  'Vacantes','Nota de prensa', 'Evento', 'Empresa afiliada Ofrece', 'Frase motivacional', 'Campaña muevete y emprende', 'Campaña Consejo laboral - video', 'Video resumen capacitación', 'Video resumen evento CCISUR', 'Servicios de Intermediación laboral', 'Alquiler de salón de eventos', 'Espacio de coworking', 'Alquiler de espacio para zona bancaria', 'Campaña de registro', 'Campaña de afiliación', 'Campaña informativa CAS - consejos'] as $area)
                        ...
                        <div class="mt-6 space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <textarea name="comentario" rows="3"
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 resize-none"
                                    placeholder="Notas internas o instrucciones adicionales">{{ old('comentario', $calendarioEditorial->comentario) }}</textarea>
                            </div>
                    ...
                    @role('admin_ti')
                        <div class="p-6 md:p-8 border-t">
                            <div class="flex items-center gap-3 mb-6">
                                <div class="p-2 bg-purple-50 rounded-lg">
                                    <svg class="w-5 h-5 text-purple-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 12l2 2 4-4m7.5-2.5a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                </div>
                                <h2 class="text-lg font-semibold text-gray-900">Control administrativo</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Enlace de publicación</label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="mt-6 space-y-2">
                                <label class="block text-sm font-medium text-gray-700">Nota administrativa</label>
                                <div class="relative">
                                    <div class="absolute top-3 left-3">
                                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <textarea name="nota_admin" rows="3"
                                        class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors duration-200 resize-none"
                                        placeholder="Notas administrativas internas">{{ old('nota_admin', $calendarioEditorial->nota_admin) }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endrole
