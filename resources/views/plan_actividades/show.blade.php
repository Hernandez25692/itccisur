                ...
                <div class="flex-1">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 mt-1">Plan de Trabajo TI
                                {{ $actividad->planTrabajo->anio ?? 'N/A' }}</p>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div class="p-3 bg-[#0C1C3C]/5 rounded-xl">
                                <svg class="w-6 h-6 text-[#0C1C3C]" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full bg-gradient-to-r from-[#C5A049] to-[#D8B96E] flex items-center justify-center text-[#0C1C3C] font-bold">
            ...
            <div class="space-y-8">
                ...
                @if ($actividad->progreso == 100)
                    <div
                        class="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-8 text-center">
                            ...
                            <form action="{{ route('actividad.ejecucion.store', $actividad->id) }}" method="POST"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="number" name="avance" min="1"
                                        ...
                                        <p class="text-sm text-gray-500 mt-2">
                                            Progreso actual: <span
                                                class="font-semibold">{{ $actividad->progreso }}%</span>
                                            • Disponible: <span
                                                class="font-semibold">{{ 100 - $actividad->progreso }}%</span>
                                        </p>
                                    </div>
                                    ...
                                    <!-- Evidencia -->
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-3">Evidencia
                                            (opcional)</label>
                                        <div
                                            class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-[#C5A049] transition-colors">
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
                                <div>
                                    <div class="flex items-center gap-3 mb-2">
                                        <span
                                            class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-800">
                                            +{{ $e->avance }}% de avance
                                        </span>
